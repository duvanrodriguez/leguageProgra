    ...
    private function dologinWithPostData()
    {
        ...
        if (empty($_POST['user_name'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                // username field)
                $sql = "SELECT u.id_usuario, u.user_name, u.nombres, u.apellidos, u.email, u.password, r.id_rol, r.nombre_rol
                             FROM usuarios u INNER JOIN roles r WHERE u.id_rol = r.id_rol AND u.user_name = '" . $user_name . "' OR email = '" . $user_name . "';";
                ...
                if ($result_of_login_check->num_rows == 1) {
                    ...
                    if (password_verify($_POST['password'], $result_row->password)) {
                        ...
                        $_SESSION['nombre_rol'] = $result_row->nombre_rol;
